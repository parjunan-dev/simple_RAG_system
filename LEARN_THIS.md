...
**Portfolio angle:** In an interview, you'd say: *"We use embeddings because semantic search handles paraphrasing and synonyms. For a production system at Cisco, we'd likely use hybrid search—embeddings for relevance, BM25 for exact keywords—to get the best of both."*
